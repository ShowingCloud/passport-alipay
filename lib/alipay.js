...
const Alipay = (options) => {
  this.options = options;
  return this;
};

Alipay.prototype.encryptedParams = (params) => {
...
Alipay.prototype.decryptedParams = (toDecrypt) => {
...
Alipay.prototype.getAccessToken = (code, cb) => {
...
Alipay.prototype.getUser = (token, cb) => {
  const callback = cb || createPromiseCallback();
